...
export interface JobSpec {
  ...
  hook_text?: string;
  /** @deprecated S117 — split into thumbnail_headline + thumbnail_subhead.
   *  Kept for backward compat; pod renderer reads headline first when present. */
  thumbnail_text?: string;
  /** S117: 4-6 word ALL CAPS pain-point headline. Pod renderer uses this in the
   *  upper text zone of the brand-frame thumbnail layout. */
  thumbnail_headline?: string;
  /** S117: 4-8 word italic Title Case amplifier. Pod renderer uses this in the
   *  lower text zone, smaller font. */
...
export interface ShortJobSpec {
  ...
  /** @deprecated S117 — split into thumbnail_headline + thumbnail_subhead. */
  thumbnail_text?: string;
  /** S117: 4-6 word ALL CAPS pain-point headline (upper zone of thumbnail). */
  thumbnail_headline?: string;
  /** S117: 4-8 word italic Title Case amplifier (lower zone). */
  thumbnail_subhead?: string;
