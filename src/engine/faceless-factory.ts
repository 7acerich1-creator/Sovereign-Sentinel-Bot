...
Generate as JSON:
{
  ...
  "thumbnail_headline": "A 3-6 word PAIN-POINT HEADLINE in ALL CAPS — the MAIN punch. Must name a feeling, lie, or trap THIS specific video diagnoses. COMPLETE STANDALONE STATEMENT, not a fragment. Voice register: Rev. Ike sermon poster — punchy, declarative, sermon-from-the-mountain — NOT entertainment power-words. Acceptable structural forms: (1) DECLARATION about a reality the viewer hasn't named, (2) COMMAND to do or undo something, (3) REVELATION exposing a hidden mechanism. HARD CONSTRAINTS: 3-6 words, max 32 chars, ALL CAPS only. NO ellipsis, NO trailing comma, NO mid-clause cutoff. CRITICAL: derive the headline from THIS video's specific thesis and segments. Do NOT copy phrases from this prompt or from prior video templates.",
  "thumbnail_subhead": "A 4-8 word ITALIC AMPLIFIER in mixed case — sits below the headline. Names the WHY or the CONSEQUENCE specific to THIS video's payoff. Complete clause that finishes the thought the headline started. HARD CONSTRAINTS: 4-8 words, max 56 chars, Title Case. NO ellipsis, NO trailing comma. CRITICAL: derive the subhead from THIS video's specific thesis and the headline you just wrote — it should make the headline SHARPER, not paraphrase generic philosophy. Do NOT reuse phrasing from this prompt, prior thumbnails, or any example libraries.",
