...
export interface JobSpec {
  ...
  hook_text?: string;
  /** 3-6 word ALL CAPS memetic trigger for thumbnail overlay.
   *  Generated by the LLM as a complete, standalone statement.
   *  Falls back to hook_text[:3 words] if omitted. */
