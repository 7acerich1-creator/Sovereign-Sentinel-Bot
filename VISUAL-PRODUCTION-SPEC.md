...
**Purpose: Single source of truth for all visual content across both brands.**
...
- **Captions:** Bold yellow/gold (#E5850F) on dark backgrounds, drop shadow for readability
...
- **Color grade:** Warm amber/gold highlights, deep midnight blue shadows, cinematic contrast
...
- **Single posts:** Dark background (#0D1B2A), gold/amber accent gradients (#E5850F → #2ECC8F), one powerful text line over a cinematic or abstract visual. Protocol 77 hook-pivot-anchor structure in copy.
...
- **Captions:** White or blood-red (#CC0000) on black/dark backgrounds, sharp sans-serif font
...
- **Color grade:** Cold blue/teal highlights, deep charcoal shadows, desaturated with pops of blood red

### Image+Text Posts (Buffer)
- **Style:** High contrast noir. Blood red + charcoal + cold blue palette. Sharp sans-serif type.
...
|-------|------------------|--------------------------|
| **Dark Psychology** | Noir cinema, amber light cutting through darkness, brutalist architecture | Surveillance camera angle, rain-slicked urban, blood red accent |
...
| **Brand** | Midnight blue + amber, throne-like composition, master architect energy | Dark room, single red light on classified document, information broker |
